...
function displayPics() {
  ...
  // The reason why we are getting an error when we change let to let is because of scope. When we had the letiable as let, we still had the ability of calling that letiable outside of the function (somehow). However, now that we have it changed to let we encounter the issue that the scope is only within the block/function itself.
  console.log(viewed);
